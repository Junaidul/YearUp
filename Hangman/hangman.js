/* Movies */
let movies = [
    "haunted house", "trick-or-treat", "jack-o’-lantern", "Halloween", "October", "pumpkin", "afraid", 
    "evil", "eerie", "gruesome", "spooky", "broomstick", "witch", "ghost", "nightmare", "cauldron", 
    "frightening", "scary", "darkness", "horrify", "disguise", "petrify", "terrify", "tombstone", 
    "cobweb", "cemetery", "ghoulish", "hocus pocus", "dead", "haunt", "howl", "dress-up", "candy", 
    "superstition", "supernatural", "cackle", "chilling", "lantern", "monster", "moonlight", "scream", 
    "grave", "vampire", "costume", "flashlight", "frightful", "wicked", "zombie", "night", "ghastly", 
    "creepy", "mysterious"
];
